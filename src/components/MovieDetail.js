    ...
    <div className="App">
        ...
        <div className="row m-0 movie-detail-div">
                ...
                <div className="col-md-9 no-image-movie text-left m-l-10 m-r-10">
                    ...
                    <h5 className="h-moviedetail">Release date : </h5> <h5 className="badge badge-success">{movie.release_date}</h5><br/>
                    <h5 className="h-moviedetail">Vote average : </h5> <h5 className="badge badge-success">{movie.vote_average}</h5><br/>
                    <h5 className="h-moviedetail">Vote count : </h5> <h5 className="badge badge-success">{movie.vote_count}</h5><br/>
                </div>
        </div>
        {this.state.recommendation != "" ?
        <div className="row recom-div m-0 m-t-40 p-15">
            <h2>Recommendations</h2>
            <MovieCard movies={this.state.recommendation}/>      
        </div>
        : <div className="row recom-div m-0 m-t-40 p-15">
